        ...
        <div>
            <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm">
                <div>
                    ...
                    <p className='w-full mid:w-2/3 text-gray-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Id dolorum
                        corporis perspiciatis animi qui rem consectetur, optio fugit illum in, quidem sint corrupti consequuntur ipsa?</p>
                </div>
